...
public class StoryRepository : IStoryRepository
{
    ...
    /// <summary>优先级排序表达式 - High=0, Medium=1, 其他=2，用于 EF Core OrderBy</summary>
    private static readonly Expression<Func<Story, int>> PriorityOrder =
        s => s.Priority == "High" ? 0 : s.Priority == "Medium" ? 1 : 2;
